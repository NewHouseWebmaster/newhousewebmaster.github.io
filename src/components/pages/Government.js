...
class Government extends Component {
  ...
  render() {
    ...
    <div className='gov-gov-container'>
        ...
        <div className='gov-row'>
          <div>iHouse</div>
	        <div>Arman Rezaee <br></br>
          Donna Hakimian</div>
          <div><a href='mailto:armanr@mit.edu'>armanr@mit.edu</a>
          <br></br>
          <a href='mailto:donnah@mit.edu'>donnah@mit.edu</a>
          </div>	
        </div>
        <div className='gov-row'>
        ...
        <div className='gov-row'>
          <div>La Maison Française</div>
	        <div>Rébecca Kleinberger
            <br></br>
            Akito van Troyer
          </div>
          <div><a href='mailto:rebklein@mit.edu'>rebklein@mit.edu</a>
          <br></br>
          <a href='mailto:akito@mit.edu'>akito@mit.edu</a>
          </div>	
        </div>
        <div className='gov-row'>
...
<div className='gov-gov-container'>
  <div className='g-title'>
        ...
        <div className='g-extra'>
          ...
          <a href="http://newhouse.mit.edu/files/constitution.pdf">Constitution</a>
          <a href="http://newhouse.mit.edu/files/policies.pdf">Rules</a>
          <a href="http://newhouse.mit.edu/files/alcohol.pdf">Alcohol</a>
